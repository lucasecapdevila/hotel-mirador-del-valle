  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path="/habitaciones/" element={<Habitaciones  setUsuarioLogueado={setUsuarioLogueado} fechaEntrada={fechaEntrada} setFechaEntrada={setFechaEntrada} fechaSalida={fechaSalida} setFechaSalida={setFechaSalida}></Habitaciones>} />
