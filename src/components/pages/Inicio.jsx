  ...
  return (
    <main className="mainPage">
      ...
      <Carousel indicators={false} id="carouselReseñas">
        <Carousel.Item>
          <img src="https://i.ibb.co/YWDrwwr/rese-a-5.png" alt="First slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img src="https://i.ibb.co/4Y8K3BX/rese-a-1.png" alt="Second slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img src="https://i.ibb.co/JFSxgjN/rese-a-2.png" alt="Third slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img src="https://i.ibb.co/SKkxx2n/rese-a-3.png" alt="Fourth slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img src="https://i.ibb.co/q5nKYzH/rese-a-4.png" alt="Fifth slide" />
        </Carousel.Item>
      </Carousel>
      <Container>
        <hr />
