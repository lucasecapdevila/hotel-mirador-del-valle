          ...
          <article className="col-lg-3 mb-1 ">
            <a href="#!" onClick={() => img1Show(true)}>
              <img
                ...
                alt="habitacion del hotel doble"
              />
            </a>
          </article>
          <article className="col-lg-3 mb-1 ms-2">
            <a href="#!" onClick={() => img2Show(true)}>
              <img
                ...
                alt="habitacion del hotel deluxe"
              />
            </a>
          </article>
          <article className="col-lg-3 mb-1 ms-2">
        ...
        <Modal.Body className="modalCard">
          <Carousel slide={false}>
            <Carousel.Item>
              <img
                src="https://www.wyndhampolanco.com/img/galeria/HABITACIONES/2020/WHYNDHAM-POLANCO-HAB-DOB-A.jpg"
                alt="habitacion del hotel suite"
              />
              <Carousel.Caption>
                <p>Suite</p>
              </Carousel.Caption>
          ...
          <Carousel slide={false}>
            <Carousel.Item>
              <img
                ...
                alt="restaurante del hotelhabitacion del hotel twin"
              />
              <Carousel.Caption>
                <p>Restaurante</p>
              </Carousel.Caption>
